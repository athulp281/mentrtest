...
const Breadcrumb = ({ title, back_home= false }) => {
  return (
    <section className="breadcrumb__area  breadcrumb__pt-310 include-bg p-relative"
      style={{ backgroundImage: 'url(/assets/img/breadcrum/abtnew.png)' }}>
        ...
        <div className="row">
          <div className="col-xxl-12">
            <div className="breadcrumb__content p-relative z-index-1">
              ...
              {!back_home &&<Link href="/contact" className="tp-btn-white-border">
               Enquire Now <i className="far fa-arrow-right"></i>
              </Link>}
              {back_home &&<Link href="/">
