const blog_data = [
  ...
  // ----------------------------------------------------
  {
    ...
    short_desc: (
      <>
        I’ve worked on everything from brand animations to cinematic visuals,
        and I’mhere to show you how to bring your ideas to life through movement
        and design. In mysessions, we won’t just learn tools — we’ll create
        visual stories that make an impact.
      </>
    ),
    duration: ".3s",
    delay: ".5s",
  ...
  },
  {
    ...
    short_desc: (
      <>
        Editing isn’t just about cutting — it’s about crafting emotion and
        rhythm. I’ll guide you through real-world techniques in editing, color
        grading, and effects, so you can confidently turn any footage into
        something powerful and professional.
      </>
    ),
    duration: ".5s",
    delay: ".7s",
  ...
  },
  {
    ...
    short_desc: (
      <>
        From logos to social media creatives, I’ve worked with brands to design
        visuals that speak loud and clear. In our sessions, I’ll help you build
        strong design fundamentals and create work that not only looks great but
